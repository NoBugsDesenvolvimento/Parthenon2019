...
public class AtividadesAux{
    ...
    /* Constructor */
    public AtividadesAux(Atividade atv){
    ...
    public AtividadesAux(){ }

    public AtividadesAux(String titulo, String sumario, int tipo, String local, String data, String hora_inicial, String hora_final, int vagas, String categoria, String latlng) {
